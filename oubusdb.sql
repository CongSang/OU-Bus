...
CREATE TABLE `seat` (
  ...
  `bus_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `seat_bus_bus_id_idx` (`bus_id`),
  CONSTRAINT `fk_seat_bus_bus_id` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `trip` (
  ...
  `date_start` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bus_id` int NOT NULL,
  `complete` tinyint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_trip_bus_bus_id_idx` (`bus_id`),
  CONSTRAINT `fk_trip_bus_bus_id` FOREIGN KEY (`bus_id`) REFERENCES `bus` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-03-22 17:30:55
